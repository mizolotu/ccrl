...
class PPO2(ActorCriticRLModel):
    ...
    """
    def __init__(self, policy, env, gamma=0.99, n_steps=1000, ent_coef=0.0, learning_rate=3e-4, vf_coef=0.5,
                 max_grad_norm=0.5, lam=0.95, nminibatches=16, noptepochs=10, cliprange=0.2, cliprange_vf=None,
