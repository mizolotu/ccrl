...
from common.save_util import data_to_json, json_to_data, params_to_bytes, bytes_to_params
from common.policies import get_policy_from_name, ActorCriticPolicy
from common.runners import AbstractEnvRunner
from common.vec_env.base_vec_env import VecEnvWrapper, VecEnv
from  common.vec_env.dummy_vec_env import  DummyVecEnv
from common.vec_env.vec_normalize import VecNormalize
from common.vec_env import unwrap_vec_normalize
...
class BaseRLModel(ABC):
    ...
    def _setup_learn(self):
        ...
        if self.ep_info_buf is None:
            self.ep_info_buf = deque(maxlen=1000 * self.n_envs)
